...
function approvedriveid(x) {
    ...
    $.ajax({
        ...
        success: function(result) {
            //   console.log("done");
            console.log(result);
            alert("Drive Approved and notification sent to students.Please refresh the page");
            //   location.reload();
        }
    });
}
...
function downloadStudentList(x) {


    console.log(x)

    $.ajax({
        url: "downloads/download.php", //the page containing php script
        type: "POST", //request type
        success: function(result) {
...
function deleteStudentid(x) {
    alert("This will result in deleating complete info of student with Enroll ");
