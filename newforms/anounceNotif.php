...
//echo '<script>alert("Done")</script>';
         $dbadstud=db_connect();
          ...
          //  $srlink=$_POST['srlinks'];
           ...
           $query="INSERT INTO Notifi(notinfo)  VALUES('".$ninfo."')";
           $result_setadddrive=mysqli_query($dbadstud,$query);

           if($result_setadddrive){
            echo '<script>alert("Notification sent.")</script>';

            // $query2="INSERT INTO s_login(logenroll)  VALUES('".$senroll."')";
            // $result_setlog=mysqli_query($dbadstud,$query2);

            // $query3="INSERT INTO sp_info(spenroll)  VALUES('".$senroll."')";
            // $result_setpsinf=mysqli_query($dbadstud,$query3);
  ...
  <div class="container-fluid nav-in-company">
    <span class="navbar-text fs-4 ">
      <!-- <a href="<?= $admlink ?>" class="text-decoration-underline"> Back</a>>   -->  Create Notifications  
    </span>
  </div>
</nav>
<section>
    ...
    <!-- <div class="input-group mb-3 mt-4">
          ...
          <input type="text" class="form-control" name="sfname" placeholder="First Name" value="<?php // if(isset($fstud['sfname'])){echo $fstud['sfname'];}?>" aria-label="Username" required>
    ...
    <div class="input-group mb-3 mt-4">
         <span class="input-group-text">*Enroll No.</span>
          <input type="number" class="form-control" placeholder="Enroll No." value="<?php // if(isset($fstud['senrollno'])){echo $fstud['senrollno'];}?>" name="seroll" aria-label="Username" required>
          <span class=" mx-2"></span>
    ...
    <div class="form-group purple-border fs-3">
  <label for="exampleFormControlTextarea4">Notification Information</label>
  <textarea  class="form-control fs-4" name="notiinfo" id="exampleFormControlTextarea4" placeholder="Enter the notification details here" required rows="6"></textarea>
</div>
    ...
    <div class="input-group mb-3 mt-4">
         <span class="input-group-text">Contact No.</span>
          <input type="number" class="form-control" name="spno" value="<?php //if(isset($fstud['spno'])){echo $fstud['spno'];}?>" placeholder="Contact No. p/w" aria-label="Username"  >
          <span class=" mx-2"></span>
          <span class="input-group-text">Email</span>
          <input type="email" class="form-control" name="semail" value="<?php // if(isset($fstud['semail'])){echo $fstud['semail'];}?>" placeholder="example@gmail.com" aria-label="Server"  >
    </div> -->
    <!-- <div class="input-group mb-3 mt-4">
  ...
  //echo $cre['onoff']=="on"?"":"disabled"; ?> >Sent Notification</button>
